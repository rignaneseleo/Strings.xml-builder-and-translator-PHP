			...
			<div class="row center">
				<form method="post" action="downloadXml.php">
					...
					if (!empty($_GET["originalXmlURL"])){
						$originalXmlURL =$_GET["originalXmlURL"];//get the url of the strings.xml file
						//todo validateXmlURL
						...
						if(!empty($_GET["translatedXmlURL"])){
							$translatedXmlURL =$_GET["translatedXmlURL"];//get the url of the strings.xml file altready partially translated
